class Doidona {
   ...
   private No raizT3;
   private No raizT2;
   private Celula primeiroT2;
   private Celula ultimoT2;
   ...
   void inserir(No i, int x){
      //inserir da arvore binaria
   }
   void inserir(Celula primeiro, Celula ultimo, int x){
      //implementar uma das opções de inserir da lista flexível
      //lembre da questão do retorno dos ponteiros.
   }
