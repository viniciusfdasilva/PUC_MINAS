...
/*
 * Função que aloca uma
 * Celula e seta as variaveis
 * de sua struct 
 * @param void
 * @return Celula
 */
...
/*
 * Função que mostra os elementos
 * da matriz dinamica
 * @param Matriz
 * @return void
 */
...
/*
 * Função que multiplica os elementos
 * da matriz dinamica
 * @param Matriz
 * @return Matriz
 */
