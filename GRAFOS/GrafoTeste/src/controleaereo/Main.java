...
public class Main extends Application{    
    ...
    public static List<Localizacao> getLatLon() throws Exception{
        ...
        DataInputStream data = new DataInputStream(new FileInputStream("/home/vinicius/Desktop/vertex.txt"));
    ...
    public static List<Adjacency> getAdjacencia() throws Exception{
        ...
        DataInputStream data = new DataInputStream(new FileInputStream("/home/vinicius/Desktop/adjacency.txt"));
        int n = Integer.parseInt(data.readLine().trim());
